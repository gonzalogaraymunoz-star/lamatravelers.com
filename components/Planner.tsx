...
export default function Planner(){
  ...
  const href=`https://wa.me/${site.phoneRaw}?text=${encodeURIComponent(`Hola LAMA, quiero planificar mi viaje a San Pedro de Atacama. Fechas: ${dates || 'por definir'}. Pasajeros: ${pax}. Me interesa: ${interest}.`)}`;
  return <div className="planner">
    ...
    <a className="button button-dark" href={href} target="_blank" rel="noreferrer">Diseñar mi viaje</a>
  </div>
}
