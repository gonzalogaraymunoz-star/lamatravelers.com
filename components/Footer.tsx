...
export default function Footer(){
  return <footer className="footer">
    <div className="footer-grid">
      ...
      <div><span className="footer-label">Planifica</span><Link href="/viajes-a-medida">Viaje a tu medida</Link><Link href="/contacto">Contacto</Link><Link href="/guia/san-pedro-de-atacama">Guía de San Pedro</Link><Link href="/politicas/cancelaciones">Cambios y cancelaciones</Link></div>
